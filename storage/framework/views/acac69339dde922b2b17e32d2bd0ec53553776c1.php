  ...
  <?php if(isset($proyecto)): ?>
    <?php $__currentLoopData = $proyecto->modulos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <li class="list-group-item">
        <span><?php echo e($modulo->title); ?></span>
        <input type="hidden" name="modulo[]" data-modulo-id="<?php echo e($modulo->id); ?>" data-modulo-titulo="<?php echo e($modulo->title); ?>" data-new="false">
        <span class="pull-right">
          <button type="button" name="button" class="btn btn-xs btn-primary moduleUpdate">
            <i class="glyphicon glyphicon-pencil"></i>
          </button>
